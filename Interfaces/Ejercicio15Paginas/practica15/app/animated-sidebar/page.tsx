...
export default function AnimatedSidebarPage() {
        ...
        <nav className="mt-4 px-2">
          {[
            ...
            <a
              key={index}
              href={item.href}
              className="mb-1 flex items-center rounded-md px-4 py-3 text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-700 dark:hover:text-white"
            >
      ...
      <div className="min-h-screen">
        <header className="flex h-16 items-center justify-between border-b bg-white px-4 dark:border-slate-700 dark:bg-slate-800">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-slate-900 dark:text-white">Barra Lateral Animada</h1>
          </div>
          <Link
            href="/"
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="rounded-lg border bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
            <h2 className="mb-4 text-2xl font-bold text-slate-900 dark:text-white">
              Navegación con Barra Lateral Animada
            </h2>
            <p className="mb-4 text-slate-600 dark:text-slate-300">
              Este ejemplo muestra una barra lateral de navegación con animaciones suaves al abrir y cerrar. Haz clic en
              el botón de menú en la esquina superior izquierda para alternar la barra lateral.
            </p>
            <div className="mt-6 rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
              ...
              <ul className="list-inside list-disc space-y-1 text-blue-700 dark:text-blue-300">
                ...
                <li>Implementa transiciones CSS para efectos de animación suaves</li>
                <li>Incluye una superposición que cierra la barra lateral al hacer clic</li>
